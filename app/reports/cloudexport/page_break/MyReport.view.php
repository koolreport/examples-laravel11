...
<form method="post">
	<div class="report-content">
		<div class="text-center">
			...
			<button type="submit" class="btn btn-primary" formaction="<?php echo url()->current(); ?>/export?type=cloudPDF">
				Cloud PDF</button>
			<button type="submit" class="btn btn-primary" formaction="<?php echo url()->current(); ?>/export?type=cloudJPG">
				Cloud JPG</button>
			<?php echo csrf_field(); ?>
		</div>
